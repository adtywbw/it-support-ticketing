...
ADD CONSTRAINT "comments_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES "tickets"("id") ON DELETE CASCADE;

ALTER TABLE "attachments" DROP CONSTRAINT "attachments_ticketId_fkey",
ADD CONSTRAINT "attachments_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES "tickets"("id") ON DELETE CASCADE;

ALTER TABLE "ticket_history" DROP CONSTRAINT "ticket_history_ticketId_fkey",
ADD CONSTRAINT "ticket_history_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES "tickets"("id") ON DELETE CASCADE;
