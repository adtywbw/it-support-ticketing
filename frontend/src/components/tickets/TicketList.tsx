...
export default function TicketList({
  ...
  const queryFilters = useMemo(
    ...
    () => ({
      ...
      ...(filters.slaStatus.length > 0 && {
        slaStatus: filters.slaStatus.join(","),
      }),
      ...
      ...(filters.locationId.length > 0 && {
        locationId: filters.locationId.join(","),
      }),
      ...(filters.requesterId.length > 0 && {
        requesterId: filters.requesterId.join(","),
      }),
  ...
  useEffect(() => {
    const totalPages =
      ...
      (data?.meta
        ? Math.ceil(data.meta.total / (data.meta.limit || limit || 10)) || 1
        : 1);
                  ...
                  >
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-primary-600 dark:text-primary-400">
                      <Link
                        ...
                        className="rounded hover:underline focus:outline-none focus:ring-2 focus:ring-primary-500"
                      >
                        {ticket.ticketNumber}
                      </Link>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {user &&
                      (user.role === "ITSupport" || user.role === "Admin") ? (
                        <select
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-navy-500 dark:text-blue-300">
                      {canAssign ? (
                        <select
                          ...
                          title={
                            ticket.assignedTo?.isActive === false
                              ? "Assigned user is inactive — reactivate to change"
                              : ""
                          }
                          className="input text-xs py-1 px-2"
                        >
