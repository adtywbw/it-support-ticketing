...
function TicketRow({ ticket }: { ticket: DashboardTicketSummary }) {
  return (
    <Link
      ...
      className="block rounded-md border border-gray-200 p-3 transition hover:border-primary-300 hover:bg-primary-50 dark:border-gray-700 dark:hover:border-primary-700 dark:hover:bg-primary-950/30"
    >
...
export default function NeedAttentionSection({ attention }: NeedAttentionSectionProps) {
  return (
    <section aria-labelledby="need-attention-heading" className="space-y-3">
      <h2 id="need-attention-heading" className="text-lg font-semibold text-gray-900 dark:text-gray-100">
        Need Attention
      </h2>
