...
export default function CurrentSnapshotCards({ current }: CurrentSnapshotCardsProps) {
  const cards = [
    { label: 'Active Tickets', value: current.activeTickets, tone: 'text-slate-900 dark:text-slate-100' },
  ...
  return (
    <section aria-labelledby="current-snapshot-heading" className="space-y-3">
      <h2 id="current-snapshot-heading" className="text-lg font-semibold text-slate-900 dark:text-slate-100">
        Current Snapshot
      </h2>
